      ...
      children: [
        ...
        Wrap(
          ...
          children: _buildButtonsList(
              ...
              state:
                  Provider.of<AdvancedFilterNotifier>(context).sortGroupButton),
        ),
        Container(
          margin: const EdgeInsets.only(top: 28),
          child: Row(
            children: [
              Text(style: Theme.of(context).textTheme.headlineMedium, "Трассы"),
            ],
          ),
        ),
        Wrap(
        ...
        SliderTheme(
          ...
          child:
              Consumer<SliderNotifier>(builder: (context, sliderNotifier, _) {
            return Slider(
          ...
          children: [
            CustomButton(
              textStyle: Theme.of(context).textTheme.headlineMedium?.copyWith(
                  color: (Provider.of<AdvancedFilterNotifier>(context)
                              .sortGroupButton
                              .isNotEmpty ||
                          ...
                          Provider.of<AdvancedFilterNotifier>(context)
                              .additionallyGroupButton
                              .isNotEmpty ||
                          Provider.of<SliderNotifier>(context).sliderValue != 0)
