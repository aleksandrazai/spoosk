        ...
        body: SingleChildScrollView(
          child: Padding(
            ...
            child: Column(children: [
              CustomGallery(
                listUrl: [
                  ...List.filled(10, true).map((e) => widget.resort!.image)
                ],
              ),
              Container(
                            ...
                            children: [
                              ...
                              Text(
                                  style: Theme.of(context)
                                      .textTheme
                                      .headlineMedium,
                                  widget.resort!.trailLength.toString()),
                              Text(" км трасс",
                                  style: Theme.of(context)
                                      .textTheme
                                      .bodyMedium!
              ...
              Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: SvgPicture.asset(image_height_mountain_ground),
                    ),
                    Text("5000 м",
                        style: Theme.of(context)
                            .textTheme
                ...
                Container(
                  ...
                  child: ChartWidget(
                      chartData:
                          Chart(easy: 10, hard: 50, medium: 20, veryHard: 20)),
                ),
                Container(
                    margin: const EdgeInsets.only(top: 20),
                    child: const Separator()),
                              ...
                              children: [
                                ...
                                Container(
                                    margin: const EdgeInsets.only(
                                        top: 8, bottom: 8),
                                    child:
                                        SvgPicture.asset(image_type_handball)),
                                Text(
                                    style: Theme.of(context)
                                        .textTheme
                                        .bodyMedium!
                              ...
                              children: [
                                ...
                                Container(
                                    margin: const EdgeInsets.only(
                                        top: 8, bottom: 8),
                                    child:
                                        SvgPicture.asset(image_type_carousel)),
                                Text(
                                    style: Theme.of(context)
                                        .textTheme
                                        .bodyMedium!
                              ...
                              children: [
                                ...
                                Container(
                                    margin: const EdgeInsets.only(
                                        top: 8, bottom: 8),
                                    child:
                                        SvgPicture.asset(image_type_bugelny)),
                                Text(
                                    style: Theme.of(context)
                                        .textTheme
                                        .bodyMedium!
